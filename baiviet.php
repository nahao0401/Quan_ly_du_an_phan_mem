							...
							<?php
								...
								foreach($result as $value)
								{
									echo '<tr>';
										...
										echo '<td class="text-center"><a href="baiviet_xoa.php?id=' . $value['ID'] . '" onclick="return confirm(\'Bạn muốn xóa bài viết ' . $value['TieuDe'] . ' không?\')"><i class="bi bi-trash text-danger"></i></a></td>';
									echo '</tr>';
								}
							?>
						</tbody>
