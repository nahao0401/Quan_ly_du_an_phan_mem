							...
							<ul class="navbar-nav">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'dien-thoai-cu']) }}">Điện thoại cũ</a></li>
									</ul>
								</li>
								<li class="nav-item">
	...
	<footer class="footer bg-dark">
		<div class="pt-5 bg-darker">
			<div class="container">
				...
				<div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">Bản quyền © 2023 bởi SmartphoneStore.</div>
			</div>
		</div>
	</footer>
