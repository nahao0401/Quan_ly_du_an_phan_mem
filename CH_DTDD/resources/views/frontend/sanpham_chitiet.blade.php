            ...
            <div class="page-title-overlap bg-dark pt-4">
                <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
                    ...
                    <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
                        <h1 class="h3 text-light mb-0">{{ $sp->tensanpham }} </h1>
                    </div>
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery">
                                    <div class="product-gallery-preview order-sm-2">
                                        <div class="product-gallery-preview-item active" id="first">
                                            <img class="image-zoom" src="{{ env('APP_URL') . '/storage/app/' . $sp->hinhanh }}" data-zoom="{{ env('APP_URL') . '/storage/app/' . $sp->hinhanh }}" width="300" />
                            ...
                            <div class="col-lg-5 pt-4 pt-lg-0">
                                <div class="product-details ms-auto pb-3">
                                    ...
                                    <div class="mb-3">
                                        <span class="h3 fw-normal text-accent me-1">{{ number_format($sp->dongia, 0, ',', '.') }}<small>đ</small></span>
                                    </div>
                ...
                <div class="row align-items-center py-md-3">
                    <div class="col-12 py-4">
                        ...
                        <p class="text-muted pb-2" style="text-align:justify"></p>
                    </div>
                </div>
            </div>
