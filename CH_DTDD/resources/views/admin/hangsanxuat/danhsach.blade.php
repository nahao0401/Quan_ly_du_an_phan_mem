	 ...
	 <div class="card">
		 ...
		 <div class="card-body table-responsive">
			 <p>
				...
				<a href="{{ route('admin.hangsanxuat.xuat') }}" class="btn btn-success"><i class="fa-light fa-download"></i><i class="bi bi-printer"></i> Xuất ra Excel</a>
			</p>
				 ...
				 <tbody>
					 @foreach($hangsanxuat as $value)
						 <tr>
							 ...
							 <td class="text-center"><a href="{{ route('admin.hangsanxuat.xoa', ['id' => $value->id]) }}" onclick = "return confirm('Bạn có muốn xóa {{ $value->tenhang }} không?')"><i class="bi bi-trash text-danger"></i></a></td>
						 </tr>
					 @endforeach
				 </tbody>
			</table>
